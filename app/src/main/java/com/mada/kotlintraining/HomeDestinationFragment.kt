 ...
 */
class HomeDestinationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_home_destination, container, false)
        transactionButton = view.findViewById(R.id.button)
